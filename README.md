...
formula you have to install in order to get a specific command. The formula is
generated by the second command which crawls all installed formulae and collect
